def regulafasi_akar(f, a, b, tol, max_iter):
    """
    Mencari akar fungsi f menggunakan metode regulafasi (secant method).
...
# Panggil fungsi regulafasi_akar untuk mencari akar
akar = regulafasi_akar(f, a, b, tol, max_iter)
